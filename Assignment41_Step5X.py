...
def LoadData(filename):
    ...
    print("Here are some readings from the Data: ")
    print(df.head())
...
def ScaleFeature(X_train,X_test):
    print(Border)
    print("Performing Scale Featuring........")
    print(Border)
...
def main():
    ...
    #Scale Feature
    X_train_Scaled, X_test_Scaled = ScaleFeature(X_train,X_test)

    #Step 4 Train Data:
    model = TrainModel(X_train_Scaled, Y_train)

    #Step 5 Test Data:
    Prediction = TestModel(model, X_test_Scaled, Y_test)
