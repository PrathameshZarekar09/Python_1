...
def Testing_Accuracy(Y_test, Prediction):
    print(Border)
...
def Training_Accuracy(Y_train, model, X_train):
    print(Border)
...
def main():
    ...
    Testing_accuracy = Testing_Accuracy(Y_test, Prediction)

    Training_accuracy = Training_Accuracy(Y_train, model, X_train)
